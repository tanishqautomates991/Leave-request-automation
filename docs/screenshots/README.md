...
![Step 1: Form Submission](/docs/Overview/.png)
...
![Step 8: Manager Approves the Request](/docs/Overview/.png)
...
![Step 9: Status Updated in Google Sheets](/docs/Overview/step-9-sheet-approved-status.png)
